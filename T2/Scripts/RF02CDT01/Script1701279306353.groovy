...
WebUI.callTestCase(findTestCase('CADASTRO_DEFAULT'), [('nome') : 'teste', ('email') : '', ('ddd') : '11'
...
WebUI.callTestCase(findTestCase('CADASTRO_DEFAULT'), [('nome') : 'teste', ('email') : 'email@email.com', ('ddd') : '11'
...
WebUI.callTestCase(findTestCase('CADASTRO_DEFAULT'), [('nome') : 'teste', ('email') : 'teste@gmail.com', ('ddd') : '11'
