...
WebUI.callTestCase(findTestCase('CADASTRO_DEFAULT'), [('nome') : 'teste', ('email') : 'email@email.com', ('ddd') : '11', ('telefone') : '222222222'
        , ('usuario') : 'teste', ('senha') : 'teste', ('repetir_senha') : 'teste', ('rua') : 'rua ', ('numero') : '200', ('bairro') : 'bairro'
        , ('complemento') : 'complemento', ('cidade') : 'Rio de Janeiro', ('uf') : 'MG'], FailureHandling.CONTINUE_ON_FAILURE)
