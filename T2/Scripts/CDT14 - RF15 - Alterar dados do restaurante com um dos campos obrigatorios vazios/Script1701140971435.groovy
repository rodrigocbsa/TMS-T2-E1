...
WebUI.setText(findTestObject('Object Repository/CDT14 - CDT15/Page_/input_cidade'), '', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('CDT14 - CDT15/Page_/input_confirmarcadastro'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementNotPresent(findTestObject('Object Repository/CDT14 - CDT15/Page_/div_Dados alterados com sucesso'), 1, FailureHandling.CONTINUE_ON_FAILURE)
